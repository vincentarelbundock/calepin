...
[]{.placeholder width=200 height=100 text="Placeholder"}
...
We can reference sections (@sec-basics), figures (@fig-scatter), tables (@tbl-planets), theorems (@thm-fermat), definitions (@def-group), and code listings (@lst-example).
...
[]{.placeholder width=150 height=100 text="A"}

[]{.placeholder width=150 height=100 text="B"}

[]{.placeholder width=150 height=100 text="C"}
...
[]{.placeholder width=300 height=200 text="Figure"}
