---
title: "Statistical Rethinking 2 with Stan and the tidyverse"
author: "Vincent Arel-Bundock"
date: "2020-08-02"
---

I've been trying to replicate (nearly) all the models in Richard McElreath's [*Statistical Rethinking (2nd ed.)*](https://xcelab.net/rm/statistical-rethinking/) book using `Stan`, `R`, `rstan`, `tidybayes`, and `ggplot2`. *This is work in progress.*
