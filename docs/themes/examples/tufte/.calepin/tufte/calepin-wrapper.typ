...
#let margin-note = marginalia.note.with(side: "right")
#let margin-sidefigure = marginalia.notefigure.with(side: "right")
...
#calepin.elements.set-margin-impl(
  note: (body, numbering: auto, side: auto) => {
    ...
    margin-note(body, numbering: numbering)
  },
  figure: (body, caption: none, side: auto) => {
    margin-sidefigure(body, caption: caption)
  },
)
