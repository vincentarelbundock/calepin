...
Calepin supports two mechanisms for specifying labels: arguments in the `#calepin.chunk()` function and `#|` Quarto-style syntax at the top of the code block. Use Quarto-style prefixes so Calepin knows what the label refers to; `fig-` labels attach to figure output.
