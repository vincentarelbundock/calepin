...
#table(
  ...
  "", `--calepin-color-accent`, "Primary accent color (links, borders, highlights).",
  "", `--calepin-color-accent-hover`, "Accent color for hover states.",
  "", `--calepin-color-accent-strong`, "Accent as a filled button background, dark enough for contrast text.",
  "", `--calepin-color-accent-strong-hover`, "Filled accent background for hover states.",
  ...
  "", `--calepin-sidebar-width`, "Desktop sidebar (left column) width.",
  "", `--calepin-toc-width`, "Desktop table-of-contents (right column) width; defaults to `--calepin-sidebar-width`.",
