...
#metadata((title: "Slides", pdf: false, tags: ("slides", "notebooks"))) <website-metadata>

#let target = sys.inputs.at("calepin-target", default: "paged")

#title()

Calepin chunks work inside any Typst slide framework: the framework handles the presentation structure, while Calepin executes code and splices the results into the deck. This page shows small decks built with #link("https://vincentarelbundock.github.io/mosaic/")[Mosaic] and #link("https://touying-typ.github.io/")[Touying].

= Mosaic

#link("https://vincentarelbundock.github.io/mosaic/")[Mosaic] turns an ordinary Typst document into polished PDF slides: headings become slides, and everything can be styled with plain Typst. It ships with modern themes, ready-made layouts, nested grids, incremental reveals, speaker notes, and handouts.
...
This section shows a small #link("https://touying-typ.github.io/")[Touying] slide deck that uses Calepin chunks.
